...
use crate::object::objects::texture3d::PerlinBuilder;
use crate::object::objects::textures::texture3d::WorleyBuilder;
...
pub enum SceneCommand {
    ...
    SetTerrainNoise(&'static str, PerlinBuilder),
...
impl Command for SceneCommand {
    ...
    fn exec(self, manager: &mut ManagerSolution) -> Self::ReturnType {
        match self {
            ...
            SceneCommand::ExtendBoundingBox(id, bb) => {
                if let Some(Component::Cloud(cloud)) =
                    manager.get_mut_scene_manager().get_mut_object(id)
                {
